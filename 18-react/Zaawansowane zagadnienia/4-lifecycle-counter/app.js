    ...
    return (
      <>
        <p>
          ...
          przekroczeniu 1000 kalkualtor mnoży przez 0.5 aż osiągnie sumę
          mniejszą niż jeden. Wtedy ponownie zaczyna mnozyć przez dwa.
        </p>
        {/* <button>Pomnóż przez: {this.state.ratio}</button> */}
